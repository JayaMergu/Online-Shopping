...
public class AdminServiceImplementation implements AdminService {
    ...
    @Override
    public Admin addAdmin(String userId, String userPassword, String key, Admin admin)
            throws AdminException, UserException, LoginException {

        User user = new User(userId, userPassword); // Create a User object

        Admin validated_admin = loginLogoutAdminService.authenticateAdmin(user, key); // Pass User object
    ...
    @Override
    public String deleteAdmin(Integer adminId, String userId, String userPassword, String key)
            throws AdminException, UserException, LoginException {
    ...
    @Override
    public Admin viewAdminById(String key, String userId, String userPassword, Integer adminId)
            throws AdminException, UserException, LoginException {
